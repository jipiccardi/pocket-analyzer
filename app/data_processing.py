...
def calculate_error_coefficients():
    ...
    errors_df['e_22'] = (open2_df['s22m'] + short2_df['s22m'] - 2*errors_df['e33'])/(open2_df['s22_o2'] - short2_df['s22_s2'])
...
#def calculate_dut_coefficients():
    ...
    #dut_c_df['s11_c'] = ((N_df['N11'] * (1 + N_df['N22'] * errors_df['e_22'])) - errors_df['e22'] * N_df['N21'] * N_df['N12']) / D_df['D']
    #dut_c_df['s12_c'] = ((N_df['N12'] * (1 + N_df['N11'] * (errors_df['e11'] - errors_df['e_11']))) / D_df['D']
    #dut_c_df['s22_c'] = ((N_df['N22'] * (1 + N_df['N11'] * errors_df['e11'])) - errors_df['e_11'] * N_df['N21'] * N_df['N12']) / D_df['D']
    #dut_c_df['s21_c'] = ((N_df['N21'] * (1 + N_df['N22'] * (errors_df['e_22'] - errors_df['e22']))) / D_df['D']
